    ...
    public void batchInsertUpdateWithStatelessSession() throws Exception {
        ...
        try {
            ...
            }
            {
                ...
                // TODO: This fails if you put a batch size on User.java, create bug report for Hibernate
                ...
                while (itemCursor.next()) {
                    ...
                    /* 
                       Because changes aren't detected automatically without a persistence context,
