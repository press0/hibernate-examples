...
public class Joins extends QueryingTest {
    ...
    // TODO: Should this be a note in the book, because it is usually the wrong result and there is no warning?
    // @Test
    public void restrictionOnFetchCollectionBad() throws Exception {
        TestDataCategoriesItems testData = storeTestData();
        ...
        try {
            ...
            EntityManager em = JPA.createEntityManager();
            {
                Query q = em.createQuery(
                    "select i, i.id from Item i left join fetch i.bids b where b.amount > 100"
                );
                List<Object[]> result = q.getResultList();
                ...
                for (Object[] tuple : result) {
                    ...
                    for (Bid bid : item.getBids()) {
                        System.out.println("#### GOT: " + bid.getAmount());
                    }
                }
            }
