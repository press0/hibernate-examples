    ...
    public void cacheBehavior() throws Exception {
        ...
        try {

            {
                ...
                /* 
                   One collection has been found in the cache, as well as the data for
    ...
    public void cacheNaturalId() throws Exception {
        ...
        try {
            ...
            { // Execute the lookup again, hit the cache
                ...
                /* 
                   Natural identifier lookup is performed with the
                   <code>org.hibernate.Session</code> API, this is the only
                   API for accessing the natural identifier cache.
                 */
                User user = (User) session.byNaturalId(User.class)
                    .using("username", "johndoe")
                    .load();
        ...
        try {
...

            {
                ...
                /* 
                   ...
                   a cache miss and not a hit. Hibernate puts the query and
