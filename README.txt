...
- Install JDK 7 (current Hibernate beta requires JDK 7, future and final
  releases will only require JDK 6).
...
- You might want to start with the helloworld module if you are unfamiliar with
  JPA or Hibernate.
